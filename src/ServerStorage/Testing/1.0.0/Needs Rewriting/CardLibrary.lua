...
local CardFactory = require(game.ServerScriptService.CardFactory)
local MoveFactory = require(game.ServerScriptService.CardFactory.MoveFactoryExperimental)

local TableUtils = require(game.ServerScriptService.Dependency.TableUtils)
local IDManager = require(game.ServerScriptService.Dependency.IDManager)
